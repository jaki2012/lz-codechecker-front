<template>
    <header>
        ...
        <el-menu :default-active="activeIndex" class="el-menu-header" menu-trigger="click" mode="horizontal" @select="handleSelect">
            ...
            <el-menu-item index="5"><a href="https://www.ele.me" target="_blank">个人管理</a></el-menu-item>
        </el-menu>
    </header>
</template>
